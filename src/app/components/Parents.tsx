...
export default function Parents({ onSelect }: Props) {
  ...
  return (
    <select onChange={(e) => onSelect(e.target.value)} name="parent" id="parent" className="bg-dark-blue-bg border border-gray-300 text-white text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-1.5 ml-2" >
