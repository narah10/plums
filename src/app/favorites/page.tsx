    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                console.log(data);
                const favoritedNotes = data.filter((note: any) => note.favorited);
                // Set both notes and filteredNotes to favorited notes
                setNotes(favoritedNotes);
                setFilteredNotes(favoritedNotes);
            } catch (error: any) {
    ...
    return (
        <main className="lg:flex min-h-screenp-24 bg-dark-blue-bg">
            ...
            <div className="w-full lg:mx-10 lg:px-5 px-10 lg:my-10 py-5">
                <h1 className="text-white text-4xl font-semibold py-5 my-2">Favorites</h1>
